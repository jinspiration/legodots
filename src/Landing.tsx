...
const Landing: React.FC<{ chooseBoard: (m: number, n: number) => void }> = ({
  chooseBoard,
}) => {
  ...
  return (
    <div className="w-full h-full grid grid-rows-[50%_50%] sm:grid-rows-1 sm:grid-cols-[50%_50%] items-center">
      <svg
        className="mx-auto w-5/6 h-5/6"
      ...
      <div className="hero">
        <div className="hero-content flex flex-col gap-5 px-5">
          ...
          <div className="grid grid-flow-col h-full w-full justify-start">
